...
electron_1.ipcMain.handle('select-workspace', function () { return __awaiter(void 0, void 0, void 0, function () {
    var result;
...
electron_1.ipcMain.handle('read-workspace', function (_, workspacePath) { return __awaiter(void 0, void 0, void 0, function () {
    var files, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, scanDirectory(workspacePath)];
            case 1:
                files = _a.sent();
                return [2 /*return*/, files];
            case 2:
                error_1 = _a.sent();
                console.error('Error reading workspace:', error_1);
                return [2 /*return*/, []];
...
// Create new file
electron_1.ipcMain.handle('create-file', function (_, folderPath, filename) { return __awaiter(void 0, void 0, void 0, function () {
    var filepath, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                filepath = path.join(folderPath, "".concat(filename, ".md"));
                return [4 /*yield*/, fs.writeFile(filepath, '# New Note\n\n', 'utf-8')];
            case 1:
                _a.sent();
                return [2 /*return*/, filepath];
            case 2:
                error_4 = _a.sent();
                console.error('Error creating file:', error_4);
                throw error_4;
            case 3: return [2 /*return*/];
        }
    });
...
function scanDirectory(dirPath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.readdir(dirPath, { withFileTypes: true })];
                case 1:
                    entries = _a.sent();
                    files = [];
